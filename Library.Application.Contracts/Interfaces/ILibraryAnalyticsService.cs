...
public interface ILibraryAnalyticsService
{
    ...
    public Task<List<BookWithCountDto>> GetBooksOrderedByTitle(DateOnly date);
    ...
    public Task<List<BookReaderWithCountDto>> GetTopReadersByNumberOfBooks(DateOnly start, DateOnly end);
    ...
    public Task<List<BookReaderWithDaysDto>> GetTopReadersByTotalLoanDays();
    ...
    public Task<List<PublisherCountDto>> GetTopPopularPublishersLastYear(DateOnly start);
    ...
    public Task<List<BookWithCountDto>> GetTopLeastPopularBooksLastYear(DateOnly start);
}
